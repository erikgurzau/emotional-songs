        ...
        do {
            ...
            switch (opt) {
                ...
                case 2:
                    ...
                    app.register(new User(name, surname, cf, address, app.nextUserId(), email, psw));
                    try { app.login(email, psw); Display.printLoginSuccess(); } catch (UserException e) { Display.printLoginFailed(e.getMessage()); }
                    break;
                case 3:
