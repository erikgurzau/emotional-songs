...
public class CanzoneService {
     ...
     * @return La canzone corrispondente all'ID specificato, se presente; altrimenti, {@code null}
     */
    public Canzone getCanzoneById(Integer id) {
        Optional<CanzoneEntity> optionalCanzone = canzoneRepository.findById(id);
        return optionalCanzone.isPresent() ? canzoneAssembler.toModel(optionalCanzone.get()) : null;
    }
